...
@section('content')
    ...
    <div class="ml-7 mb-5 text-gray-500">
        <a href="/admin_inventory_index">Index</a><span> / </span><a href="#">Medicine List</a>
    </div>
    <div class=" m-auto bg-white h-[500px] rounded-lg shadow" style="width: 95%;">
        <div class="p-5">
            <a href="/admin/add_medicine">
                <button class="text-sm bg-blue-900 text-white p-2 rounded-sm">Add New Medicine</button>
            </a>
        </div>
        <div class="m-auto h-14 rounded-t border-t-2 border-t-green-600 bg-green-200 items-center hidden" id="addsuccess"
            style="width:95%;">
            <h1 class="ml-2 font-semibold text-green-800 p-3">Medicine Successfully Added!</h1>
        </div>
                    ...
                    @forelse ($medicines as $medicine)
                        <tr class="dark:border-neutral-600 hover:bg-neutral-100 dark:hover:bg-neutral-300">
                            ...
                            <th scope="row"
                                ...
                                <a href="/updatemedicine/{{ $medicine->id }}" id="update-doctor">
                                    <button
                                ...
                                <button
                                    ...
                                    id="delete_medicine" value="{{ $medicine->id }}"><i
