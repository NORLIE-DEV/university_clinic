...
@section('content')
    ...
    @if ($doctor->department == 'physician')
        <form id="medicalConsultationWalkinForm" method="POST" enctype="multipart/form-data" class="mt-10">
            {{ csrf_field() }}
                ...
                <div class="tab-content" id="tab-content-1">
                    ...
                    <div class="flex gap-5 justify-center pt-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="weight" id="weight" class="border text-xs p-2 w-72 outline-none"
                                min="0">
